    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function ScaleSlider() {
                ...
                if (parentWidth)
                    jssor_slider1.$ScaleWidth(Math.min(parentWidth, 745));
                else
...
<div class="mainpage">
	<div class="firstpage">
	<div class="firstpage1"> <img src="images/logo.png" width="210px" height="160px"></div>
	<div class="firstpage2">
		LOOKING FOR BEST PLACE FOR PROGRAMMING</div>
	<div class="firstpage3"> www.iipacademy.com
		<br>
		<strong>info@iipacademy.com</strong>
		<br>
		<h3>+91-8003215312</h3></div>
	</div>
<div class="secondarypage">
	<div class="secondarypage1"><b><a href="index.php">Home</a></b></div>
	<div class="secondarypage2"><b><a href="courses.php">Courses</a></a></b></div>
	...
	<div class="secondarypage5"><b><a href="contact.php">Contact us</a></b></div>
	<div class="secondarypage6"><b><a href="about.php">About us</a></b></div>
</div>
	<div class="thirdpage">
		<div class="thirdpage1">
			<div class="thirdpage1a"><b>Home</b></div>
			<div class="thirdpage1b"><b>Courses</b></div>
			<div class="thirdpage1c"><b>Gallery</b></div>
			<div class="thirdpage1d"><b>Enquiry</b></div>
			<div class="thirdpage1e"><b>Contact us</b></div>
			<div class="thirdpage1f"><b>About us</b></div>
		</div>
			<div class="thirdpage2">
							 <!-- Jssor Slider Begin -->
    <!-- To move inline styles to css file/block, please specify a class name for each element. --> 
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 745px;
        ...
        <!-- Slides Container -->
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 745px; height: 240px;
            overflow: hidden;">
            <div>
                <a u=image href="#"><img src="img/landscape/01.jpg" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:745px; height:30px;"> 
	...
	<div class="fourthpage1">
       
         	</div>
	<div class="fourthpage2">
		<div class="fourthpage2a"><u>Courses</u></div>
		<div class="fourthpage2b">1.) Website Development (HTML, CSS, JAVASCRIPT,PHP, MYSQL)</div>
		<div class="fourthpage2c">2.) Android</div>
		<div class="fourthpage2d">3.) Java - Advance JAVA</div>
		<div class="fourthpage2e">4.) .NET</div>
		<div class="fourthpage2f">5.) I-PHONE&nbsp&nbsp&nbsp        6.) SEO &nbsp&nbsp&nbsp          7.) C / C++</div>
	</div>
	<div class="fourthpage3"></div>
	</div>
	<div class="fifthpage">
		
		<div class="fifthpagea"></div>
		<div class="fifthpageb">Home&nbsp&nbsp|&nbsp&nbspAbout Us&nbsp&nbsp|&nbsp&nbspCourses&nbsp&nbsp|&nbsp&nbspGallery&nbsp&nbsp|&nbsp&nbspEnquiry&nbsp&nbsp|&nbsp&nbspContact Us</div>
		<div class="fifthpagec"></div>
	</div>
	</div>
</div>
</body>
