...
<?php
           include("connection.php");
            $run=mysql_query("select * from whyiip order by nid DESC LIMIT 5 ");
?>
<html>
<head>
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            var _SlideshowTransitions = [
                //Rotate Overlap
                { $Duration: 1200, $Zoom: 11, $Rotate: -1, $Easing: { $Zoom: $JssorEasing$.$EaseInQuad, $Opacity: $JssorEasing$.$EaseLinear,
				$Rotate: $JssorEasing$.$EaseInQuad }, $Opacity: 2, $Round: { $Rotate: 0.5 }, $Brother: { $Duration: 1200, $Zoom: 1, $Rotate: 1, $Easing: $JssorEasing$.$EaseSwing, $Opacity: 2, $Round: { $Rotate: 0.5 }, $Shift: 90 } },
                //Switch
                { $Duration: 1400, x: 0.25, $Zoom: 1.5, $Easing: { $Left: $JssorEasing$.$Eas]eInWave, $Zoom: $JssorEasing$.$EaseInSine }, $Opacity: 2, $ZIndex: -10, $Brother: { $Duration: 1400, x: -0.25, $Zoom: 1.5, $Easing: { $Left: $JssorEasing$.$EaseInWave, $Zoom: $JssorEasing$.$EaseInSine }, $Opacity: 2, $ZIndex: -10 } },
                //Rotate Relay
...
<div class="mainpage">
    ...
    <div id="slider1_container" style="position: relative; top: 0px; left: 0px; width: 745px;
        ...
        <div u="slides" style="cursor: move; position: absolute; left: 0px; top: 0px; width: 745px; height: 240px;
            overflow: hidden;">
            <div>
                <a u=image href="#"><img src="img/landscape/01.png" /></a>
            ...
            <div>
                <a u=image href="#"><img src="img/landscape/02.png" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:745px; height:30px;"> 
                random caption transition
                </div>
            </div>
            <div>
                <a u=image href="#"><img src="img/landscape/03.png" /></a>
                <div u=caption t="*" class="captionOrange"  style="position:absolute; left:20px; top: 30px; width:745px; height:30px;"> 
	...
	<div class="fourthpage1">
		<div class="fourthpage1a"><b><u>WHY DONOR HUB?</b></u></div>
	        <?php $a=1?>
            <?php
            ...
            ?>
                ...
                <table>
                    <tr>
                <td align="center"><?php echo $a."&nbsp".$showtitle ?></td>
            </tr>
        </table>
        <?php
         $a++;   
	...
	<div class="fourthpage2">
		<div class="fourthpage2a"><u>Services</u></div>
		<div class="fourthpage2b">1.) KIDNEY DONATION)</div>
		<div class="fourthpage2c">2.) BONE MARROW</div>
		<div class="fourthpage2d">3.) EYE DONATION</div>
		<div class="fourthpage2e">4.) BLOOD</div>
		<div class="fourthpage2f">5.) HEART&nbsp&nbsp&nbsp         &nbsp&nbsp&nbsp          </div>
	</div>
